...
OrgChart.prototype.load = function (t) {
    ...
    this.server.read(t, this.width(), this.height(), e, O, v, function (t) {
        ...
        if (OrgChart.events.publish("render", [x, e]), r = e.content, r += x.ui.lonely(x.config), O !== OrgChart.action.exporting) {
            ...
            O === OrgChart.action.centerNode ? OrgChart.anim(x.getSvg(), {viewbox: a}, {viewbox: x.response.viewBox}, x.config.anim.duration, x.config.anim.func, function () {
            ...
            }) : !a || !x.response || a[0] == x.response.viewBox[0] && a[1] == x.response.viewBox[1] && a[2] == x.response.viewBox[2] && a[3] == x.response.viewBox[3] || O !== OrgChart.action.insert && O !== OrgChart.action.expandCollapse && O !== OrgChart.action.update && O !== OrgChart.action.init ? 0 == g[0].length && (c || (y && y(), OrgChart.events.publish("redraw", [x]), c = !0)) : OrgChart.anim(x.getSvg(), {viewbox: a}, {viewbox: x.response.viewBox}, 500, OrgChart.anim.inOutPow, function () {
            ...
            var f = t.boundary, u = f.maxX - f.minX, C = f.maxY - f.minY, m = x.ui.svg(u, C, [f.minX, f.minY, u, C], x.config, r, i);
            y(m)
        }
    }, function (t) {
    ...
    if (null != i) {
        ...
        if (null != a) {
            ...
            var h = i.w, d = i.h, c = n < h - n ? h - n : n, g = l < d - l ? d - l : l, p = (g = g) < (c = c) ? c : g, f = document.createElementNS("http://www.w3.org/2000/svg", "g"),
                u = document.createElementNS("http://www.w3.org/2000/svg", "clipPath"), C = document.createElementNS("http://www.w3.org/2000/svg", "rect"),
    ...
    var i = t.pid;
    return null != i && null != i && "" != i || (i = t.id), this._draw(!1, OrgChart.action.update, {id: i}, function () {
        r.ripple(t.id)
    }), !0
    ...
    Array.isArray(c) || (c = [c]), Array.isArray(g) || (g = [g]), Array.isArray(p) || (p = [p]), O = setInterval(function () {
        for (var t = 0; t < c.length; t++) for (var e in p[t]) {
            ...
            switch (e.toLowerCase()) {
                case"d":
                    var a = u((10 * v - 10) / f) * (p[t][e][0] - g[t][e][0]) + g[t][e][0], o = u((10 * v - 10) / f) * (p[t][e][1] - g[t][e][1]) + g[t][e][1];
    ...
    null == i && (i = !1);
    var n = document.createElement("div"), l = document.createElement("div"), s = document.createElement("input"), h = document.createElement("hr"), d = document.createElement("button");
    ...
    n.className = "edit-tags", a.innerHTML = '<svg style="width: 34px; height: 34px;"><path style="fill:#ffffff;" d="M21.205,5.007c-0.429-0.444-1.143-0.444-1.587,0c-0.429,0.429-0.429,1.143,0,1.571l8.047,8.047H1.111 C0.492,14.626,0,15.118,0,15.737c0,0.619,0.492,1.127,1.111,1.127h26.554l-8.047,8.032c-0.429,0.444-0.429,1.159,0,1.587 c0.444,0.444,1.159,0.444,1.587,0l9.952-9.952c0.444-0.429,0.444-1.143,0-1.571L21.205,5.007z"></path></svg>', Object.assign(a.style, {
        ...
        top: "7px",
        right: "7px"
    }), Object.assign(o.style, {"overflow-x": "hidden", "overflow-y": "auto"}), Object.assign(i.style, {
        "background-color": "#039BE5",
        "min-height": "50px",
        textAlign: "center",
        position: "relative"
    }), Object.assign(n.style, {margin: "12px"}), this.wrapperElement.appendChild(e), e.appendChild(i), e.appendChild(o), o.appendChild(n), i.appendChild(a), OrgChart.htmlRipple(i);
    ...
    this.obj.element.appendChild(this.wrapperElement), i.addEventListener("click", function () {
        r.hide(!1)
    }), this.obj._hideBeforeAnimation(), OrgChart.anim(this.wrapperElement, {right: -150, opacity: 0}, {right: 0, opacity: .9}, 300, OrgChart.anim.inOutSin, function () {
    ...
    l.className = "edit-assistant-button-content", a.innerHTML = '<svg style="width: 34px; height: 34px;"><path style="fill:#ffffff;" d="M21.205,5.007c-0.429-0.444-1.143-0.444-1.587,0c-0.429,0.429-0.429,1.143,0,1.571l8.047,8.047H1.111 C0.492,14.626,0,15.118,0,15.737c0,0.619,0.492,1.127,1.111,1.127h26.554l-8.047,8.032c-0.429,0.444-0.429,1.159,0,1.587 c0.444,0.444,1.159,0.444,1.587,0l9.952-9.952c0.444-0.429,0.444-1.143,0-1.571L21.205,5.007z"></path></svg>', this.wrapperElement.id = "bgEditForm", Object.assign(a.style, {
        ...
        top: "7px",
        right: "7px"
    }), Object.assign(n.style, {"overflow-x": "hidden", "overflow-y": "auto"}), Object.assign(r.style, {
        "background-color": "#039BE5",
        "min-height": "50px",
        textAlign: "center",
        position: "relative"
    }), Object.assign(o.style, {margin: "14px 14px 7px", color: "#4285F4", cursor: "pointer"}), Object.assign(l.style, {
    ...
    t.isGroup || t.isChildOfGroup || 0 != t.childrenIds.length || this._addField(n, l, "isAssistant", "edit"), t.isGroup || this._addField(n, o, "Add new field", "edit"), this.obj.element.appendChild(this.wrapperElement), r.addEventListener("click", function () {
        ...
        if ("Save" == o.innerHTML) OrgChart.anim(o, {opacity: 1}, {opacity: 0}, 200, OrgChart.anim.inSin, function () {
            ...
            if (n.removeChild(t), e && !OrgChart._arrayContains(i.fields, e)) {
                ...
                r.style.opacity = 0, n.insertBefore(r, o), OrgChart.anim(r, {opacity: 0}, {opacity: 1}, 200, OrgChart.anim.inSin, function () {
            ...
            t.style.opacity = 0, t.id = "bgNewField", n.appendChild(t), OrgChart.anim(t, {opacity: 0}, {opacity: 1}, 200, OrgChart.anim.inSin, function () {
    ...
    if (this.wrapperElement) {
        ...
        if (this.node.isGroup && (e = {Name: this.obj.config.tags[this.node.id].groupName}), t) {
            ...
            var l = this;
            this.obj._hideBeforeAnimation(), OrgChart.anim(l.wrapperElement, {right: 0, opacity: 1}, {right: -150, opacity: 0}, 300, OrgChart.anim.inOutSin, function () {
        ...
        for (var f = this.wrapper.getElementsByTagName("div"), u = 0; u < f.length; u++) {
            (a = f[u]).addEventListener("mouseover", function () {
                ...
                if (void 0 === l[r].onClick) if ("add" === r) {
                    ...
                    expandChildren: !1,
                    nodeId: o
                }) : "pdf" === r ? s.obj.exportPDF({filename: "OrgChart.pdf", expandChildren: !1, nodeId: o}) : "png" === r ? s.obj.exportPNG({
    ...
    return OrgChart.events.on(t, e, this._event_id), this
},void 0 === OrgChart && (OrgChart = {}),OrgChart.idb = {version: 1, dbName: "balkangraph", tableName: "orgchart-js", keyPath: "id"},OrgChart.idb.db = null,OrgChart.idb._open = function (e) {
    ...
    if (e) {
        ...
        var r = this.div.querySelector('[data-tlbr="plus"]'), i = this.div.querySelector('[data-tlbr="minus"]'), a = this.div.querySelector('[data-tlbr="fit"]'),
            o = this.div.querySelector('[data-tlbr="expand"]'), n = this;
    ...
    this._draw(!1, OrgChart.action.exporting, t, function (t) {
        ...
        if (r.innerHTML = t, "svg" == a.ext) if (o) o(a, r.innerHTML); else {
            var e = {content: r.innerHTML, options: a}, i = OrgChart.events.publish("exportstart", [n, e]);
            if (!1 === i) return !1;
    ...
    var r = e.getAttribute("width"), i = e.getAttribute("height"), a = OrgChart.pdfPrevUI._getViewBox(e), o = {w: parseFloat(r), h: parseFloat(i)};
    ...
    var n = OrgChart.pdfPrevUI._getViewBox(e),
        l = {w: t.landscape ? o - (t.margin[1] + t.margin[3]) : a - (t.margin[1] + t.margin[3]), h: t.landscape ? a - (t.margin[0] + t.margin[2]) : o - (t.margin[0] + t.margin[2])},
        s = {w: t.landscape ? o : a, h: t.landscape ? a : o}, h = r / l.w, d = i / l.h, c = d < h ? h : d, g = n[0], p = n[1] / c, f = n[2], u = n[3] / c;
    ...
    var i = OrgChart.pdfPrevUI._getViewBox(e), a = 0, o = 0;
    switch (t.format) {
        case"A4":
        case"A42Levels":
            a = OrgChart.A4w, o = OrgChart.A4h;
    ...
    if (-1 != e.type.indexOf("touch") && (1 == e.touches.length ? this._touch = {x: e.touches[0].clientX, y: e.touches[0].clientY} : this._touch = null, r = {
        move: "touchmove",
        up: "touchend",
    ...
    if (-1 != e.type.indexOf("touch") && this._touch && 1 == e.changedTouches.length) {
        if (e.changedTouches.length) {
            var r = e.changedTouches[0].clientX, i = e.changedTouches[0].clientY, a = OrgChart.t(this.config.template, this.getScale()).size, o = this.getScale(), n = Math.abs(r - this._touch.x) / o,
    ...
    var r = this, i = !1, a = this.config.zoom.speed, o = this.config.zoom.smooth, n = 0, l = this.getScale(), s = OrgChart._centerPointInPercent(r.getSvg(), e.pageX, e.pageY);
    ...
    if (this.config.enableDragDrop) {
        var r = OrgChart._getClientXY(e), i = t.getAttribute("node-id"), l = this.getBGNode(i);
        if (!1 !== OrgChart.events.publish("drag", [this, i])) {
            ...
            if (c.insertBefore(m, c.firstChild), m.style.opacity = .7, l.isChildOfGroup) {
                var a = this.getNodeElement(l._groupParentNodeId), o = OrgChart._getTransform(a);
    ...
    var r = this.getViewBox(), i = this.getSvg(), a = i.getAttribute("width"), o = i.getAttribute("height"), n = a / r[2], l = o / r[3], s = l < n ? l : n;
    ...
    var h = this.getViewBox(), d = this.getScale(), i = OrgChart._getClientTouchesXY(e, 0), a = OrgChart._getClientTouchesXY(e, 1),
    ...
    if ("pan" == c.type) {
        ...
        var n = OrgChart._getOffsetXY(this.element, e), l = n.x / d + h[0] - 16 / d, g = n.y / d + h[1] - 16 / d;
    ...
    var p = function (t) {
        ...
        if (c && "pan" == c.type) {
            ...
            var a = OrgChart._getClientTouchesXY(t, 1), o = Math.sqrt((e.x - a.x) * (e.x - a.x) + (e.y - a.y) * (e.y - a.y)), n = 1 + (o - c.dist) / (c.dist / 100) / 100;
            c.dist = o;
    ...
    r.style.display = "none", e.style.width = "50px", e.style.display = "block", e.style.opacity = 0, OrgChart.anim(e, {width: 50, opacity: 0}, {
        width: 300,
        opacity: 1
    ...
    var e = this.obj.element.querySelector('[data-id="search-icon"]'), i = this.obj.element.querySelector('[data-id="search"]'), a = this.obj.element.getElementsByTagName("input")[0];
    ...
    var o = function () {
        ...
        var t = i.querySelector('[data-selected="yes"]').getAttribute("data-search-item-id"), e = OrgChart.events.publish("searchclick", [r.obj, t]);
    ...
    var h = this.maxX, d = this.maxY, c = this.minX, g = this.minY, p = this.root, f = this.nodes, u = this.groupChildren;
    if (t) {
    ...
    var o = this, n = OrgChart.server._createNodes(this.config, this.action, this.actionParams, this.oldNodes);
    t(n);
    var l = n.nodes, s = n.roots, e = OrgChart.remote;
    ...
    for (var i = a.nodes, o = {}, n = [], l = [], s = [], h = {}, d = !1, c = 0; c < i.length; c++) {
        var g = i[c], p = Array.isArray(g.tags) ? g.tags.slice(0) : [], f = OrgChart._getGroup(p, a.tags), u = OrgChart._getTemplate(p, a.tags, a.template);
    ...
    for (c = 0; c < n.length; c++) {
        ...
        if (OrgChart.server._isNotNullEmptyUndefined(v.pid)) (H = o[v.pid]) ? ((v.parent = H).children.push(v), H.childrenIds.push(v.id)) : (v.pid = null, v.parent = null, v.isAssistant = !1, l.push(v)); else v.isAssistant = !1, l.push(v);
    ...
    for (c = 0; c < s.length; c++) {
        ...
        if (H) {
            ...
            for (b = k.length - 1; 0 <= b; b--) {
                if (b % 2 && b != k.length - 1) (J = new OrgChart.node(H.id + "_split_" + N, null, [], "split")).isAssistant = !0, o[J.id] = J, k.splice(b, 0, J.id), N++; else b % 2 && k.splice(b, 0, _.id)
            }
    ...
    if (t == OrgChart.action.centerNode) {
        ...
        for (var H = OrgChart.server._getRealParent(P), U = P.id; null != H;) {
            if (-1 != (D = m.indexOf(H.id)) && m.splice(D, 1), H.state = OrgChart.EXPAND, e.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS) for (c = 0; c < H.childrenIds.length; c++) {
            ...
            if (H.state == OrgChart.EXPAND) for (var F = 0; F < H.childrenIds.length; F++) {
        ...
        if (e.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS) for (c = 0; c < P.childrenIds.length; c++) {
            if (-1 != (D = m.indexOf(P.childrenIds[c])) && m.splice(D, 1), (z = o[P.childrenIds[c]]).state = OrgChart.EXPAND, !z.isAssistant && !OrgChart.server._isSplit(z)) for (b = 0; b < z.childrenIds.length; b++) {
                var D, G = o[z.childrenIds[b]];
                -1 == (D = m.indexOf(z.childrenIds[b])) && m.push(z.childrenIds[b]), G.state = OrgChart.COLLAPSE
            }
        }
    }
    ...
    if (a.layout == OrgChart.mixed) for (c = 0; c < n.length; c++) {
    ...
    if (a.layout == OrgChart.tree || a.layout == OrgChart.treeRightOffset || a.layout == OrgChart.treeLeftOffset) {
        ...
        for (c = 0; c < q.length; c++) {
            ...
            var V = [];
            for (b = H.children.length - 1; 0 <= b; b--) {
                if (OrgChart.server._mixedLayoutAllNodes(H)) if (0 == (z = H.children[b]).childrenIds.length && !z.isAssistant && "split" != z.templateName && (z.parent && "split" != z.parent.templateName || z.parent.isAssistant)) {
            ...
            for (N = 1, b = V.length - 1; 0 <= b; b--) {
                var J;
                if (b % 2 && b != V.length - 1) (J = new OrgChart.node(H.id + "_split_" + N, null, [], "split")).layout = OrgChart.tree, o[J.id] = J, V.splice(b, 0, J.id), N++; else b % 2 && V.splice(b, 0, _.id)
            }
    ...
    if (r == OrgChart.action.init && t) {
        ...
        if (a.state == OrgChart.COLLAPSE) o.push(t.id); else if (a.state == OrgChart.EXPAND) {
            var s;
    ...
    var i = OrgChart.t(e), a = i.size[0], o = i.size[1];
    ...
    if (null != t.x && null != t.y) {
        if (e.lazyLoading && i !== OrgChart.action.exporting) {
            function a(t, e) {
                var r = t.x, i = t.y, a = t.w, o = t.h, n = e[0] - OrgChart.LAZY_LOADING_FACTOR, l = e[2] + OrgChart.LAZY_LOADING_FACTOR + e[0], s = e[1] - OrgChart.LAZY_LOADING_FACTOR,
                    h = e[3] + OrgChart.LAZY_LOADING_FACTOR + e[1], d = n < r + a && r < l;
    ...
    if (t.isGroup && t.groupState == OrgChart.EXPAND) for (var r = OrgChart.t(t.templateName), i = 0, a = 0, o = 0; o < t.bgnodes.length; o++) {
        var n = t.bgnodes[o];
    ...
    var u = {}, C = {top: null, left: null, bottom: null, right: null, minX: null, maxX: null, minY: null, maxY: null}, m = [[], [], []], O = a - n + 2 * i.padding, v = o - l + 2 * i.padding,
    ...
    for (var S in g) {
        ...
        if (OrgChart.server._isVisible(I, i, s, d)) {
            ...
            if (d == OrgChart.action.expandCollapse && f && f[I.id] && "expandCollapseToLevel" == c.method) {
                ...
                var B;
                if (null != (T = f[I.id]).x && null != T.y && (N = {x: T.x, y: T.y}), (B = g[c.id]) && B == I) (M = I.parent) && M.id == c.id && (N = {
                    x: B.x + B.w / 2 - I.w / 2,
                    y: B.y + B.h / 2 - I.h / 2
                })
    ...
    _defsIds: {}, defs: function (t) {
        ...
        var m = OrgChart._getPosition(r, t, a, o), O = "node";
        Array.isArray(t.tags) && t.tags.length && (O += " " + t.tags.join(" ")), t.layout && (O += " tree-layout");
        var v = OrgChart.nodeOpenTag.replace("{id}", t.id).replace("{class}", O).replace("{level}", t.level).replace("{x}", m.x).replace("{y}", m.y), y = OrgChart._getOpacity(r, t);
        ...
        var a = "", o = 0, n = 0, l = OrgChart.t(t.templateName, i);
        switch (e.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
        ...
        var a = OrgChart.t(t.templateName, i), o = [], n = r.levelSeparation / 2;
    ...
    var a = OrgChart._getTopLeft(t), o = i.touches[0].pageX - a.x, n = i.touches[0].pageY - a.y, l = i.touches[1].pageX - a.x, s = i.touches[1].pageY - a.y;
    return [((o - l) / 2 + l) / (e / 100), ((n - s) / 2 + s) / (r / 100)]
},OrgChart._browser = function () {
    var t = !!window.opr && !!opr.addons || !!window.opera || 0 <= navigator.userAgent.indexOf(" OPR/"), e = "undefined" != typeof InstallTrigger,
        ...
        i = !!document.documentMode, a = !i && !!window.StyleMedia, o = !(!window.chrome || !window.chrome.webstore && !window.chrome.runtime);
    return {opera: t, firefox: e, safari: r, msie: i, edge: a, chrome: o, blink: (o || t) && !!window.CSS}
},OrgChart._menuPosition = function (t, e, r) {
    var i = t.getBoundingClientRect(), a = r.getBoundingClientRect(), o = e.getBoundingClientRect(), n = i.left - a.left, l = i.top - a.top;
    ...
    var i = (new DOMParser).parseFromString(e, "text/xml").getElementsByTagName("text")[0], a = parseFloat(i.getAttribute("x")), o = parseFloat(i.getAttribute("y")), n = i.getAttribute("text-anchor"),
        l = i.getAttribute("width"), s = i.getAttribute("text-overflow"), h = "http://www.w3.org/2000/svg", d = r.getElementsByTagName("svg")[0].getElementsByTagName("text")[0],
    ...
    for (var o = [], e = function (t) {
        ...
        return e + "\n"
    }, r = "", i = 0; i < t.length; i++) for (var a in t[i]) OrgChart._arrayContains(o, a) || (o.push(a), r += a + ",");
    r += "\n";
    ...
    if ((this.config.mouseScrool == OrgChart.action.xScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
        ...
        !function (t, i, e) {
            ...
            t.addEventListener("wheel", function (t) {
                var e = 0;
                if (n.config.mouseScrool == OrgChart.action.xScroll) (e = t.deltaX || t.wheelDeltaX) || (e = t.deltaY || t.wheelDeltaY); else if (n.config.mouseScrool == OrgChart.action.scroll && !(e = t.shiftKey ? t.deltaY || t.wheelDeltaY : t.deltaX || t.wheelDeltaX)) return;
    ...
    if (this.config.mouseScrool == OrgChart.action.yScroll || this.config.mouseScrool == OrgChart.action.scroll) {
        ...
        !function (t, i, e) {
            ...
            t.addEventListener("wheel", function (t) {
                var e = 0;
                if (n.config.mouseScrool == OrgChart.action.yScroll) (e = t.deltaY || t.wheelDeltaY) || (e = t.deltaX || t.wheelDeltaX); else if (n.config.mouseScrool == OrgChart.action.scroll && !(e = t.shiftKey ? t.deltaX || t.wheelDeltaX : t.deltaY || t.wheelDeltaY)) return;
                e = -e, t.preventDefault(), e = Math.max(-1, Math.min(1, e)), n.pos += -e * i;
    ...
    var a, o, n, l = r.element.querySelector("#bg-ppdf-size"), s = r.element.querySelector("#bg-ppdf-layout"), h = r.element.querySelector("#bg-ppdf-scale"),
        d = r.element.querySelector("#bg-ppdf-margin"), c = r.element.querySelector("#bg-ppdf-header"), g = r.element.querySelector("#bg-ppdf-footer");
    ...
    for (var r, i, a, o, n, l = "", s = 0; s < this.config.clinks.length; s++) {
        ...
        if ((d.isChildOfGroup || e.res.visibleNodes[d.id]) && ((!d.isChildOfGroup || e.res.visibleNodes[d._groupParentNodeId]) && (c.isChildOfGroup || e.res.visibleNodes[c.id]) && (!c.isChildOfGroup || e.res.visibleNodes[c._groupParentNodeId]))) {
            ...
            var S = (r = O, a = k, void 0, o = ((i = v).x - r.x) / 2 + r.x, n = (i.y - r.y) / 2 + r.y, {x: (o - a.x) / 2 + a.x, y: (n - a.y) / 2 + a.y});
    ...
    function t(t, e, r) {
        ...
        var n = OrgChart.t(t.templateName, S), l = _.config.levelSeparation;
        (t.parent && t.parent.layout == OrgChart.mixed || t.parent && t.parent.layout == OrgChart.tree) && (l = _.config.mixedHierarchyNodesSeparation);
        var s = {p: t.x + t.w / 2 + n.expandCollapseSize, q: t.y, r: t.x + t.w / 2 + n.expandCollapseSize, s: I.minY + l};
        ...
        if (A += '<g c-link-from="{from}" c-link-to="{to}">'.replace("{from}", t.id).replace("{to}", e.id) + n.link.replace("{d}", y), N.label) {
            var x = n.label.replace("{x}", m.x).replace("{y}", m.y).replace("{val}", N.label), b = OrgChart._getLabelSize(x), w = -b.height / 2;
            switch (_.config.orientation) {
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    w = b.height
